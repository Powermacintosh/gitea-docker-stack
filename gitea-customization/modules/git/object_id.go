...
func NewIDFromString(hexHash string) (ObjectID, error) {
    ...
    // Determine object format strictly by hex length to allow parsing
    // both SHA-1 (40) and SHA-256 (64) IDs regardless of runtime feature flags.
    switch len(hexHash) {
    case Sha1ObjectFormat.FullLength():
        theObjectFormat = Sha1ObjectFormat
    case Sha256ObjectFormat.FullLength():
        theObjectFormat = Sha256ObjectFormat
    default:
